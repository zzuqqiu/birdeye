(function (i)
{
	var l = { version: "1.0.7", debug: false };
	...
	function h(s, r)
	{
		if (s instanceof Array)
		{
			...
			{
				if (r.call(s[q], s[q], q) === false) { return }
			}
		} else
		{
			for (var q in s) { if (s.hasOwnProperty(q)) { if (r.call(s[q], s[q], q) === false) { return } } }
		}
	}
